...
def get_alerts(
    ...
    if not alerts:
        default_alerts = [
            {
                "id": "alert-low-stock-beef",
                "alert_type": "low_stock",
                "severity": "HIGH",
                "product_id": "Ground Beef",
                "message": "Ground Beef inventory (8kg) is below required lunch shift buffer (10kg). Stockout risk in ~2 hours."
            },
            {
                "id": "alert-waste-lettuce",
                "alert_type": "overstock",
                "severity": "MEDIUM",
                "product_id": "Fresh Iceberg Lettuce",
                "message": "Fresh Iceberg Lettuce holding time nearing 24h safety limit. Prioritize prep or salad promotions."
            },
            {
                "id": "alert-weather-surge",
                "alert_type": "demand_surge",
                "severity": "INFO",
                "product_id": "Brioche Burger Buns",
                "message": "Sunny weekend forecast + concert event lift predicts +25% burger demand surge tomorrow."
            }
        ]
