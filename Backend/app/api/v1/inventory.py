...
def get_snapshots(
    ...
    if not snapshots:
        default_snaps = [
            {"id": "inv-snap-chicken", "product_id": "Chicken Breast", "quantity": 18.5},
            {"id": "inv-snap-beef", "product_id": "Ground Beef", "quantity": 8.0},
            {"id": "inv-snap-cheese", "product_id": "Mozzarella Cheese", "quantity": 25.0},
            {"id": "inv-snap-tomatoes", "product_id": "Crushed Tomatoes", "quantity": 40.0},
            {"id": "inv-snap-buns", "product_id": "Brioche Burger Buns", "quantity": 120.0},
            {"id": "inv-snap-lettuce", "product_id": "Fresh Iceberg Lettuce", "quantity": 12.0},
            {"id": "inv-snap-flour", "product_id": "All-Purpose Flour", "quantity": 35.0},
        ]
        for s in default_snaps:
