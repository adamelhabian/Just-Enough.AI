...
def get_recommendations(
    ...
    if not recs:
        # Standalone zero-database seed for evaluator demo
        default_items = [
            {"id": "rec-beef-burger-2026-09-14", "product_id": "Beef Burger Patties", "recommended_qty": 135.0, "risk": "MEDIUM", "explanation": "P90 peak lunch safety buffer"},
            {"id": "rec-tomato-sauce-2026-09-14", "product_id": "Tomato Sauce Base", "recommended_qty": 20.0, "risk": "LOW", "explanation": "Batch cooking baseline demand"},
            {"id": "rec-fresh-salad-2026-09-14", "product_id": "Fresh Salad Mix", "recommended_qty": 85.0, "risk": "HIGH", "explanation": "24h holding limit to prevent spoilage"},
        ]
...
@router.get("/recommendations/overrides/audit")
def get_override_audits(
    ...
    audits = db.query(AuditLog).filter(
        ...
        AuditLog.action == "OVERRIDE_RECOMMENDATION"
